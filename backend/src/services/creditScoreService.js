    ...
    calculateScore(data) {
        ...
        if (data.bureauScore) {
            ...
            factors.push({
                ...
                impact: bureauWeight > 50 ? 'positive' : 'negative',
        ...
        if (data.incomeStability) {
            ...
            factors.push({
                ...
                impact: incomeWeight > 50 ? 'positive' : 'negative',
        ...
        if (data.employmentStability) {
            ...
            factors.push({
                ...
                impact: empWeight > 50 ? 'positive' : 'negative',
        ...
        if (data.debtToIncome) {
            ...
            factors.push({
                ...
                impact: dtiWeight > 50 ? 'positive' : 'negative',
        ...
        if (data.repaymentHistory) {
            ...
            factors.push({
                ...
                impact: repWeight > 50 ? 'positive' : 'negative',
        ...
        if (data.digitalBehavior) {
            ...
            factors.push({
                ...
                impact: digWeight > 50 ? 'positive' : 'negative',
        ...
        negativeFactors.forEach(f => {
            switch(f.factor) {
                ...
                case 'Income Stability':
                    recommendations.push('Build a consistent income history');
                    break;
